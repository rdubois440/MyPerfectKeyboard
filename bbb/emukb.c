...
static const char *cmds[] = {
	...
	"echo 0x1234 >/sys/kernel/config/usb_gadget/kb/idVendor",
	"echo 0x5678 >/sys/kernel/config/usb_gadget/kb/idProduct",
	"echo 0x0100 >/sys/kernel/config/usb_gadget/kb/bcdDevice",
	"echo 0x0110 >/sys/kernel/config/usb_gadget/kb/bcdUSB",
	"mkdir /sys/kernel/config/usb_gadget/kb/configs/c.1",
	// TODO strings
	"echo 500 >/sys/kernel/config/usb_gadget/kb/configs/c.1/MaxPower",

	"mkdir /sys/kernel/config/usb_gadget/kb/functions/hid.usb0",
	"echo 1 >/sys/kernel/config/usb_gadget/kb/functions/hid.usb0/subclass", // boot interface subclass
	"echo 1 >/sys/kernel/config/usb_gadget/kb/functions/hid.usb0/protocol", // keyboard
	"echo 8 >/sys/kernel/config/usb_gadget/kb/functions/hid.usb0/report_length",
...
static const char *remove_cmds[] = {
	"rm /sys/kernel/config/usb_gadget/kb/configs/c.1/hid.usb0",
	"rmdir /sys/kernel/config/usb_gadget/kb/functions/hid.usb0",
};
